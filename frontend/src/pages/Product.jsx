...
const Product = () => {
  ...
  // Get product from location state or fallback data
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <nav className="mb-8">
        <ol className="flex items-center space-x-2 text-sm">
          <li>
            <button onClick={() => navigate('/')} className="text-gray-500 hover:text-pink-600">
              Home
            </button>
          </li>
          <li className="text-gray-400">/</li>
          <li>
            <button onClick={() => navigate('/products')} className="text-gray-500 hover:text-pink-600">
              Perfumes
            </button>
          </li>
          <li className="text-gray-400">/</li>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
        ...
        <div className="space-y-4">
          ...
          <div className="flex space-x-4 justify-center">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="w-20 h-20 bg-gray-100 rounded-lg border-2 border-transparent hover:border-pink-300 cursor-pointer transition-colors">
                <img
                  src={product.image}
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-3">
              {sizes.map((sizeOption) => (
                ...
                >
                  {sizeOption.popular && (
                    <span className="absolute -top-2 left-1/2 transform -translate-x-1/2 bg-pink-500 text-white text-xs px-2 py-1 rounded-full">
                      Popular
                    </span>
                  )}
          ...
          <div className="space-y-4">
            <button
              ...
              className="w-full bg-gradient-to-r from-pink-500 to-purple-600 text-white py-4 px-6 rounded-xl font-semibold hover:shadow-lg transform hover:scale-105 transition-all duration-200"
            >
              Buy Now - ${(currentPrice * quantity).toFixed(2)}
            </button>
            <button
              onClick={handleAddToCart}
              className="w-full bg-white border-2 border-pink-500 text-pink-600 py-4 px-6 rounded-xl font-semibold hover:bg-pink-50 transition-colors"
            >
              Add to Cart
            </button>
          </div>
        ...
        <div className="max-w-4xl">
          {activeTab === 'description' && (
            <div className="prose prose-lg max-w-none">
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                This exquisite fragrance represents the pinnacle of perfumery craftsmanship. Each bottle contains 
                carefully selected ingredients sourced from the finest regions around the world. The composition 
                follows traditional French perfumery techniques while incorporating modern innovations in scent development.
              </p>
              <p className="text-gray-700 leading-relaxed">
                Perfect for both day and evening wear, this versatile fragrance adapts to your skin's natural chemistry 
                to create a unique scent signature. The longevity and sillage have been carefully balanced to provide 
                an elegant presence without being overwhelming.
              </p>
            </div>
          )}
                ...
                {[
                  {
                    ...
                    rating: 5,
                    date: '2 weeks ago',
                    review: 'Absolutely love this fragrance! The longevity is incredible and I get compliments every time I wear it. Perfect for both day and night.'
                  },
                  {
                    name: 'Michael R.',
                    rating: 4,
                    date: '1 month ago', 
                    review: 'Great scent with excellent projection. The only downside is the price point, but the quality justifies it. Will definitely repurchase.'
                  },
                  {
                    name: 'Emma L.',
                    rating: 5,
                    date: '1 month ago',
                    review: 'This has become my signature scent. Elegant, sophisticated, and unique. The bottle design is also beautiful - looks great on my vanity.'
                  }
                ].map((review, index) => (
