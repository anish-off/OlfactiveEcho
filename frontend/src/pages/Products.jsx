...
const Products = () => {
  ...
  const perfumes = [
    ...
    },
    {
      ...
      description: 'A fresh and woody composition that captures the essence of wide open spaces.',
      rating: 4.7,
      reviews: 1890
    },
    {
      ...
      price: 150,
      category: 'oriental',
      image: '/assets/tom-ford-black-orchid.jpg',
      description: 'A luxurious and sensual fragrance with notes of black orchid, spice, and dark chocolate.',
      rating: 4.6,
      reviews: 1234
    },
    {
      ...
      price: 85,
      category: 'fresh',
      image: '/assets/acqua-di-gio.jpg',
      description: 'A fresh aquatic fragrance inspired by the Mediterranean sea breeze.',
      rating: 4.5,
      reviews: 3210
    },
    {
      ...
      price: 110,
      category: 'oriental',
      image: '/assets/ysl-black-opium.jpg',
      description: 'A mysterious and alluring fragrance with coffee, vanilla, and white flowers.',
      rating: 4.7,
      reviews: 1567
    },
    {
      ...
      price: 320,
      category: 'woody',
      image: '/assets/creed-aventus.jpg',
      description: 'A sophisticated blend of pineapple, birch, and musk for the modern gentleman.',
      rating: 4.9,
      reviews: 987
    },
    {
      ...
      price: 75,
      category: 'floral',
      image: '/assets/marc-jacobs-daisy.jpg',
      description: 'A youthful and feminine fragrance with notes of wild berries and jasmine.',
      rating: 4.4,
      reviews: 2103
    },
    {
      ...
      price: 90,
      category: 'fresh',
      image: '/assets/dolce-light-blue.jpg',
      description: 'Captures the essence of the Mediterranean with citrus and bamboo notes.',
      rating: 4.3,
      reviews: 1876
    },
    {
      ...
      price: 125,
      category: 'floral',
      image: '/assets/flowerbomb.jpg',
      description: 'An explosion of flowers with jasmine, rose, and patchouli.',
      rating: 4.6,
      reviews: 1432
    },
    {
      ...
      price: 105,
      category: 'woody',
      image: '/assets/terre-hermes.jpg',
      description: 'A woody and mineral fragrance connecting man to earth and the elements.',
      rating: 4.5,
      reviews: 1098
    },
    {
      ...
      price: 100,
      category: 'floral',
      image: '/assets/la-vie-est-belle.jpg',
      description: 'A sweet and gourmand fragrance celebrating life\'s simple pleasures.',
      rating: 4.4,
      reviews: 1765
    },
    {
      ...
      price: 70,
      category: 'floral',
      image: '/assets/versace-bright-crystal.jpg',
      description: 'A luminous and fresh floral fragrance with pomegranate and peony.',
      rating: 4.2,
      reviews: 1543
    }
  ]
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="text-center mb-12">
        <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
          Discover Your 
          <span className="bg-gradient-to-r from-pink-600 to-purple-600 bg-clip-text text-transparent"> Signature Scent</span>
        </h1>
          ...
          >
            <div className="relative overflow-hidden bg-gradient-to-br from-pink-50 to-purple-50">
              ...
              <div className="absolute top-4 right-4 bg-white rounded-full px-3 py-1 shadow-md">
                <span className="text-sm font-semibold text-pink-600">${perfume.price}</span>
              </div>
            </div>
            
            <div className="p-6">
              <div className="flex items-center justify-between mb-2">
                <span className="text-xs font-medium text-purple-600 bg-purple-100 px-2 py-1 rounded-full uppercase tracking-wide">
                  {perfume.category}
                </span>
